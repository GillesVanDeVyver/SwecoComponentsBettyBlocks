  ...
  jsx: (() => {
    ...
    const renderRadio = (optionValue, optionLabel) => (
      <div className="custom-control custom-radio">
        <input className="custom-control-input" type="radio" id={optionLabel} value={optionValue} name={nameAttributeValue || customModelAttributeName} />
        <label htmlFor={optionLabel} className="custom-control-label">{optionLabel}</label>
      </div>
    );
